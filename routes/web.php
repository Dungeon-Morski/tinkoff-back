...
Route::group(['namespace' => 'App\Http\Controllers\Admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::delete('/admin/requisites/{id}', [RequisiteController::class, 'deleteRequisite'])->name('deleteRequisite');
    ...
    Route::delete('/admin/withdraw-methods/{method_id}', [WithdrawMethodController::class, 'deleteMethod'])->name('deleteWithdrawMethod');
